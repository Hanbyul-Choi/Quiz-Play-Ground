  ...
  return (
    <div className="w-screen h-screen">
      <div className="flex flex-col items-center font-medium gap-y-16">
        <h1 className="mt-8 mb-12 text-3xl">인물 퀴즈</h1>
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-[60px]">
            <div className="flex flex-col items-center rounded-xl w-[470px] h-[500px] bg-hoverSkyblue shadow-md justify-center gap-y-16 text-2xl">
              <img className="p-8" src={testImg} alt="" />
            </div>
            <form className="flex flex-col items-center rounded-xl w-[470px] h-[500px] border-4 border-gray2 justify-center">
